...
#ifndef SUPPORTIO_SWIFT_H
#define SUPPORTIO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SupportIO",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class AcquireIOConfig;

SWIFT_CLASS("_TtC9SupportIO9AcquireIO")
...
@interface AcquireIO (SWIFT_EXTENSION(SupportIO))
...
SWIFT_CLASS("_TtC9SupportIO15AcquireIOConfig")
...
@interface UIViewController (SWIFT_EXTENSION(SupportIO))
- (void)awakeFromNib;
@end
