...
#ifndef SUPPORTIODEMO_SWIFT_H
#define SUPPORTIODEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SupportIODemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class AcquireIOConfig;

SWIFT_CLASS("_TtC13SupportIODemo9AcquireIO")
...
@interface AcquireIO (SWIFT_EXTENSION(SupportIODemo))
...
SWIFT_CLASS("_TtC13SupportIODemo15AcquireIOConfig")
...
@property (nonatomic, copy) NSString * _Nonnull buttonImageName;
...
@property (nonatomic, copy) NSString * _Nonnull webSocketServer;
...
@property (nonatomic) BOOL useDefaultTheme;
...
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nonnull themeOptions;
...
@property (nonatomic) BOOL showThreadList;
...
@property (nonatomic) BOOL showChatButton;
...
@property (nonatomic) BOOL sessionConnectAndStartAuto;
...
@property (nonatomic) BOOL removeVideoCallDisconnectButton;
...
///   </li>
/// </ul>
@property (nonatomic) BOOL isHideNewChat;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
@interface UIViewController (SWIFT_EXTENSION(SupportIODemo))
- (void)awakeFromNib;
@end
